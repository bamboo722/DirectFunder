...
if (isset($recb) and isset($recb['user_goo_voi_num']))
	$recb['user_goo_voi_num'] = '('.substr($recb['user_goo_voi_num'],0,3).') '.substr($recb['user_goo_voi_num'],3,3).'-'.substr($recb['user_goo_voi_num'],6,4);
if ($eml_templ_white == "")
...
$smtp_mail_usr = "Ducana2016@gmail.com";//gmail account
$smtp_mail_pw = "Morgan123";//gmail account password
	    ...
	    { 
	    	...
	    	for ($i=0;$i<$eml_to_cnt;$i++)
            {
            	...
            	try {
					...
					$max_id++;
					//$email_body .= "<img border='0' src='http://www.directfunder.com/prospects-mobile/trackonline.php?email=$eml_to_tok[$i]&id=$max_id&subject=$email_subj' width='1' height='1' alt='image for email' >";
...
//$mail->Username    = "duc@directfunder.com";
//Password to use for SMTP authentication
////$mail->Password    = "w532UrzC";
//$mail->SMTPSecure  = 'tls';
//Set who the message is to be sent from
$mail->setFrom('Ducana2016@gmail.com', 'Ducana');
//Set an alternative reply-to address
//$mail->addReplyTo('replyto@example.com', 'First Last');
//Set who the message is to be sent to
$mail->addAddress('wilsontan76@hotmail.com', 'Wilson');
//Set the subject line
$mail->Subject = 'PHPMailer SMTP test';
//Read an HTML message body from an external file, convert referenced images to embedded,
//convert HTML into a basic plain-text alternative body
//$mail->msgHTML(file_get_contents('contents.html'), dirname(__FILE__));
$mail->msgHTML("KKKKKKKKKKKKKK");
