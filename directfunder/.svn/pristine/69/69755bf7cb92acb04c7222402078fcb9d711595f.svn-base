...
{ 
		...
		$sql="select user_group,password,owner,google_voice_ph,google_acc_nm,google_acc_pwd,google_acc_recov_eml,skype_number from admin_user where user_id='".$login."'";  
        ...
        $google_acc_recov_eml = trim($array_pass_check['google_acc_recov_eml']);
        $skype_number = trim($array_pass_check['skype_number']);
		...
		{	
			...
			if (($res_rec['cur_login_time'] == null) || ($res_rec['cur_login_time'] == "0000-00-00 00:00:00"))
			{
                ...
                $_SESSION['skype_number']=$skype_number;
