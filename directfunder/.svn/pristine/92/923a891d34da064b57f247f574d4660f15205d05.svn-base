...
{
   while ($res_rec = mysql_fetch_assoc($res_sel)) {
...
{ 
	...
	else
	{
		...
		else
		{
			...
			{
				$_POST['owner'] = $_SESSION['user_login'];
				$_POST['user_group'] = 'Agent';
			}
			...
			values
			 ...
			 '".clean($_POST['pw'])."',
			 '".clean($_POST['emailid'])."',
			 '".clean($_POST['user_group'])."',
			 '".clean($_POST['google_voice_ph'])."',
			 '".clean($_POST['google_acc_nm'])."',
			 '".clean($_POST['google_acc_pwd'])."',
			 '".clean($_POST['owner'])."',
			 '".clean($_POST['skype_number'])."'
			 )";
			mysql_query($sql_ins) or die(mysql_error());
			$msg="Add sales agent is successed!";
			
			// insert user into aut_dial_status_info
			$sql_ins = sprintf("insert into auto_dial_status_info(user_id,auto_status) values ('%s','%d')",clean($_POST['username']),0);
			mysql_query($sql_ins) or die(mysql_error());
		    ...
		    <div class='row'>
		    	<div class='col-sm-offset-2 col-sm-8 col-sm-offset-2'>
		          <form name="default_emplate" id="default_emplate" method="post" enctype="multipart/form-data" onsubmit="return stepcheck();">
		            ...
		            ?>
		            		<div class='form-row'>
				          	  <div class='col-sm-6 form-group' style="margin-left:0px;margin-right:0px">
				                <label class='control-label'>User Group</label>
				                <select class='form-control' onchange="javascript:ChangeUserGroup()" name="user_group" id="user_group" size="1">
				              ...
				              <div class='col-sm-6 form-group' style="margin-left:0px;margin-right:0px">
				                ...
				                <select class='form-control' name="owner" id="owner" size="1">
				            	<?php 
				            		for ($i=0;$i<count($response['user_id']);$i++)
				            		{
								?>
										 <option value="<?php echo $response['user_id'][$i];?>" "<?php if ($response['user_id'][$i] == $_POST['owner'])  echo 'selected';?>"><?php echo $response['user_id'][$i];?></option>
								<?php		
									}
								?>	                                  
			                    </select>	                   
		            ...
		            <div class='form-row'>		              
		              <div class='col-sm-6 form-group' style="margin-left:0px;margin-right:0px">
		               ...
		               <div class='col-sm-6 form-group' style="margin-left:0px;margin-right:0px">
		                ...
		                <input name="emailid" type="text" id="emailid"  class='form-control' value="<?php if(isset($_POST['emailid'])){echo $_POST['emailid'];}?>">
		     		  </div>
		  			...
		  			<div class='form-row'>
		               ...
		               <div class='col-sm-6 form-group' style="margin-left:0px;margin-right:0px">
		                <label class='control-label'>Google Voice Phone Number</label>
		                <input name="google_voice_ph" class='form-control' type="text" id="google_voice_ph" class="textbox_small" value="<?php if(isset($_POST['google_voice_ph'])){echo $_POST['google_voice_ph'];}?>">		                
		              </div>
		              
		               <div class='col-sm-6 form-group' style="margin-left:0px;margin-right:0px">
		                <label class='control-label'>Google Account Name</label>
		                <input name="google_acc_nm" class='form-control' type="text" id="google_acc_nm" class="textbox_small" value="<?php if(isset($_POST['google_acc_nm'])){echo $_POST['google_acc_nm'];}?>">		                
		              </div>
		            </div>
		            ...
		            <div class='form-row'>
		               ...
		               <div class='col-sm-6 form-group' style="margin-left:0px;margin-right:0px">
		                <label class='control-label'>Google Account Password</label>
		                <input name="google_acc_pwd" class='form-control' type="text" id="google_acc_pwd" class="textbox_small" value="<?php if(isset($_POST['google_acc_pwd'])){echo $_POST['google_acc_pwd'];}?>">		                
		              </div>

					  <div class='col-sm-6 form-group' style="margin-left:0px;margin-right:0px">
		                <label class='control-label'>Skype Number</label>
		                <input name="skype_number" class='form-control' type="text" id="skype_number" class="textbox_small" value="<?php if(isset($_POST['skype_number'])){echo $_POST['skype_number'];}?>">		                
		              </div>
		            </div>    
		           
		           	<div class='form-row'>		
		           		<center>
							<div class='form-group' style="margin-left:0px;margin-right:0px;width:60%">
