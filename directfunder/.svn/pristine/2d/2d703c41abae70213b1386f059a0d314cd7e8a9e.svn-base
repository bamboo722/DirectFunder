...
if($rec_sel['customer_id']!='')
{
   ...
   $sql_ins = "insert into customer_info "
                ...
                . "dur_info,calls_md_info,calls_conn_info,conv_min_info,eml_snd_info,eml_rcv_info,lead_src,bst_time_to_call,p_psn2,pp_fl_nm,p_ph1,p_ph2,p_eml1,p_eml2,p_amt_req,p_cmt,p_fr_nm,p_mi_nm,"
