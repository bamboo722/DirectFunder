...
if(isset($_POST["submit"]) and $_POST["submit"] == "Import")
{
	...
	while(($filesop = fgetcsv($handle, 1000, ",")) !== false)
	{
		if ($c!=0)
		{
	        ...
	        //$sql = "insert into customer_info (customer_id,apply_dt,lead_src,priority_opt,p_fl_nm,p_eml1,p_ph1,p_hm_addr,remarks,agent) values ('".$recid."','".$filesop[0]."','".$recid."','".$recid."','"
	        $sql = sprintf("INSERT INTO customer_info (customer_id,apply_dt,agent,lead_src, priority_opt,p_fl_nm,p_eml1,p_ph1,p_hm_addr,remarks) VALUES ('%s',sysdate(),'%s','%s','%s','%s','%s','%s','%s','%s')",$recid,$agent,$filesop[0],$filesop[1],$filesop[2],$filesop[3],$filesop[4],$filesop[5],$filesop[6],$filesop[7]);
	...
	if($sql_res){
		$msg="You database has imported successfully. You have inserted ". $c ." recoreds";
...
<body>
	...
	<form name="frmSearch" method="post" enctype="multipart/form-data" action="importfromcsv.php">
		<div class="container">
			<h1>&nbsp;</h1>
	   		<div class="row">
	   			<div class="col-sm-offset-4 col-sm-4 col-sm-offset-4 col-xs-12">
		   			<center>
		   				<div class="panel panel-primary">
							<div class="panel-heading"><center><h4>Import From CSV</h4></center></div>
							<div class="panel-body">
								<div class='form-row'>
									<input type="file" class="form-control" name="csv_file" style="border:0px;"/><br />
								</div>
								<div class='form-row'>
