        ...
        <div class="tab-pane fade in active" id="profile">         
            ...
            <div class = "col-sm-6">
	            ...
	            <div class="form-group float-label-control"> 
		            <table style="width:100%;">  
		            	<tr>
		            		<td style="width:25%;"><label for="">Twilio Number</label></td>
		    				<td><input type="text" class="form-control" placeholder="<?php echo $rws['user_tw_number'];?>" name="user_tw_number" value="<?php if (isset($rws['user_tw_number'])) echo $rws['user_tw_number']; else echo $_SESSION['tw_number']?>"></td>
		            	</tr>
		            </table>
	            </div>
	            <div class="form-group float-label-control"> 
