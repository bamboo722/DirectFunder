            ...
            $(document).ready(function () {
				...
				*/
				...
				$("#send_eml_btn_mobile").on("click", function() {
					console.log("send email mobile button");					
					$("#dialog_email").modal();
				});
						...
						<div id="tab-container" class="head-box-layer">		                                           
	                        ...
	                        <div>  
	                            <table class="head-box mobile-info-box" style="background-color: #3e75b4;">
	                                ...
	                                <tr align="center">
	                                     <td ><div id="dur_div"><?php echo '00:00:00';?></div>                                                      
	                                    </td>
	                                </tr>                                     
	                            </table>
	                        </div>
								...
								<form class="form"  style="margin:2px 2px 2px 4px;" method="post" action="searchbuyer.php">
		                            ...
		                            <div class="panel panel-default" style="margin-bottom:5px">
									    ...
									    <div class="panel-body">
									    	<div class="form-group my-form-group">
									    		<center>
													<!--<button type="button" class="btn btn-success btn-md my-sms-button" id="phone_call_btn">Call<span id="call_new_span" style="visibility:hidden;color:white !important;background-color:red !important" class="badge"></span></button>-->
													<button type="button" class="btn btn-success btn-sm " id="send_sms_btn">SMS<span id="sms_news_span" style="visibility:hidden;color:white !important;background-color:red !important" class="badge"></span></button>
													<button type="button" class="btn btn-success btn-sm " id="send_eml_btn">Email<span id="email_new_span" style="visibility:hidden;color:white !important;background-color:red !important" class="badge"></span></button>									    			
									    		</center>
									    	</div>											    						    	
									  	</div>
																	...
																	?>
																   	  	<tr>
																	   	   	<td style="padding:1px;" align="center">
																	   	  	    <input type="text"  style=" <?php if (isset($response) and isset($response['opportunity']) and $response['opportunity']!='') echo 'border:0px;';?>" name="op_opportunity[]" id="op_opportunity[]" value="<?php if ($response!=false){	if (isset($response['opportunity'])) { echo $response['opportunity']; } else  { echo ''; }	}else	echo $opportuntiy_name_ary[$i]; 	 	?>"/>
				                                                            </td>
				                                                            <td style="padding:1px;" align="center">
				                                                            ...
				                                                            <td style="padding:1px;" align="center">
										                                   	 	<input type="text"    name="op_ref_comp_nm[]" id="op_ref_comp_nm[]" value="<?php 
																	   	  	...
																	   	  	<td style="padding:1px;"  align="center"> 
																	   	 	 	<input type="text"    name="op_ref_pers_nm[]" id="op_ref_pers_nm[]" value="<?php 
																	   	  	...
																	   	  	<td style="padding:1px;" align="center"> 
																					...
																					<?php 
					                                                            		...
					                                                            		{?>
					                                                            			<div style="padding:0px;margin:0px" class="col-md-8 col-sm-8 col-xs-8">
					                                                            				<input type="text"  style="width:100%" name="op_ph1[]" id="op_ph1[]" value="<?php 
					                                                            			...
					                                                            			<div class="col-md-4 col-sm-4 col-xs-4" style="padding:0 0 0 1px;margin:0px">
							                                                                	<button type="button"  onclick="javascript: ClicktoPhone((document.getElementsByName('op_ph1[]'))['<?php echo $i?>'].value);" class="btn btn-success btn-xs" style="height:26px;width:100%">Call</button>
							                                                                </div>							                                                              
																					<?php
																						}else
																						{?>
																							<input type="text"  style="display:inline-block;" name="op_ph1[]" id="op_ph1[]" value="<?php 
																						   	  	 if (($response!=false) and isset($response['phone1'])) {
							                                                                       	echo $response['phone1'];
							                                                                     }else {
							                                                                     	echo '';
																			...
																			<td style="padding:1px;" align="center"> 
					                                                                ...
					                                                                <?php 
					                                                            		...
					                                                            		{?>
					                                                            			<div style="padding:0px;margin:0px" class="col-md-8 col-sm-8 col-xs-8">
						                                                            			<input type="text"   style="width:100%;" name="op_ph2[]" id="op_ph2[]" value="<?php 
					                                                            			...
					                                                            			<div class="col-md-4 col-sm-4 col-xs-4" style="padding:0 0 0 1px;margin:0px">
							                                                               		<button type="button"  onclick="javascript: ClicktoPhone((document.getElementsByName('op_ph2[]'))['<?php echo $i?>'].value);" class="btn btn-success btn-xs" style="height:26px;width:100%">Call</button>																							    
																							</div>	
																						...
																						<?php
																							...
																							<input type="text"  style="display:inline-block;" name="op_ph2[]" id="op_ph2[]" value="<?php 
																					   	  	 	 if (($response!=false) and isset($response['phone2'])) {
							                                                                        echo $response['phone2'];
							                                                                      } else  {
							                                                                            echo '';
																	   	  	...
																	   	  	<td style="padding:1px;" align="center"> 
								                                                    ...
								                                                    <?php 
					                                                            		...
					                                                            		{?>
					                                                            			<div style="padding:0px;margin:0px" class="col-md-8 col-sm-8 col-xs-8">
					                                                            				<input type="text"   style="width:100%;" name="op_bst_eml[]" id="op_bst_eml[]" value="<?php 
					                                                            			...
					                                                            			<div class="col-md-4 col-sm-4 col-xs-4" style="padding:0 0 0 1px;margin:0px">
										                                        				<button type="button" onclick="javascript: ClicktoEmail((document.getElementsByName('op_bst_eml[]'))['<?php echo $i?>'].value);" class="btn btn-success btn-xs" style="height:26px;width:100%">Email</button>    
																							</div>	
																					...
																					<?php
																						...
																						{?>
																							<input type="text"  style="display:inline-block;" name="op_bst_eml[]" id="op_bst_eml[]" value="<?php 
																						   		if (($response!=false) and isset($response['best_email'])) {
										                                                        	echo $response['best_email'];
										                                                        }else{
										                                                        	echo '';
																	   	  	...
																	   	  	<td style="padding:1px;"   align="center"> 
																	   	 	 	<input type="text"    name="op_fee_amt[]" id="op_fee_amt[]" value="<?php 
																	   	  	...
																	   	  	<td style="padding:1px;" align="center"> 
																	   	 		<input type="text"   name="op_date_paid[]" id="op_date_paid[]" onFocus='popUpCalendar(this, this, "mm/dd/yyyy")'  value="<?php 
																	   	  	...
																	   	  	<td style="padding:1px;" align="center"> 
																	   	 	 	<input type="text"   name="op_notes[]" id="op_notes[]" value="<?php 
															...
															<?php	
																...
																while ($response = mysql_fetch_assoc($res_sel)) 																
															   	{					  	  	
									                                ...
									                                if ($response['log_time'] > $_SESSION['last_logout']) {
