<?php
    ...
    if(isset($_POST)){
		...
		else  if ($_POST['submit'] == "SaveProfile")	// save profile
        {
	        ...
	        $user_tw_number=$_POST['user_tw_number'];
	        ...
	        $sql_upd="UPDATE profile_info SET user_avatar='$New_ProfileImageName',user_tw_number='$user_tw_number',user_firstname='$user_firstname',user_lastname='$user_lastname',user_email='$user_email',user_tw_number='$user_tw_number' WHERE user_username = '$temp'";
	        $sql_ins="INSERT INTO profile_info (user_avatar,user_username,user_firstname,user_lastname,user_email,user_tw_number) VALUES ('$New_ProfileImageName','$user_username','$user_firstname','$user_lastname','$user_email','$user_tw_number')";
