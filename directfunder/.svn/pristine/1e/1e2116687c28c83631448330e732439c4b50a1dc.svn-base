		           		...
		           		<div class="table-responsive" style="height:500px; overflow:auto; overflow-y:scroll;">    
		           			<table class="table table-striped">
		      					...
		      					<?php
									...
									while($v_sel = mysql_fetch_assoc($res_sel))
									{
								?>
				                      <tr style="font-size:12px"> 
				                        ...
				                        <td class="col-xs-3">Active</td>
				                        <td class="col-xs-3"><a href="changecredential.php?uid=<?php echo $v_sel['user_id']?>" onClick="picopen('changecredential.php?uid=<?php echo $v_sel['user_id']?>','popup', 300, 300); return false;" target="popup" class="main_txt_red">Change</a></td>
